...
const page:FC<props>= (props) => {
 ...
 const [route,setRoute]=useState('Login');
  return (
    ...
    <Heading title="FAQ - Online-Learning" description="Online-Learning id a platform for student to learn and get help from teacher" keywords="=Programing,MERN,React" />
